...
#define BT04_E_UART_TX_GPIO_CLK             RCC_APB2Periph_GPIOC
/* 这里对于时钟开启，需要先确认该GPIO挂载在哪个时钟组下 */
#define BT04_E_UART_TX_GPIO_CLK_ENABLE()    do{   RCC_APB2PeriphClockCmd(BT04_E_UART_TX_GPIO_CLK, ENABLE); } while (0) 

#define BT04_E_UART_RX_GPIO_PORT            GPIOD
#define BT04_E_UART_RX_GPIO_PIN             GPIO_PIN_2
#define BT04_E_UART_RX_GPIO_CLK             RCC_APB2Periph_GPIOD
#define BT04_E_UART_RX_GPIO_CLK_ENABLE()    do{   RCC_APB2PeriphClockCmd(BT04_E_UART_RX_GPIO_CLK, ENABLE); } while (0) 

#define BT04_E_UART_INTERFACE               UART5
#define BT04_E_UART_IRQn                    UART5_IRQn
#define BT04_E_UART_CLK                     RCC_APB1Periph_UART5
#define BT04_E_UART_IRQHandler              UART5_IRQHandler
#define BT04_E_UART_CLK_ENABLE()            do{   RCC_APB1PeriphClockCmd(BT04_E_UART_CLK, ENABLE); } while (0) 
